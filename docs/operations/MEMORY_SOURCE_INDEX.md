...
| OmniRoute | Documentation snapshot at [`0730eee`](https://github.com/diegosouzapw/OmniRoute/tree/0730eee9f2a2185395b2dbe652f33187d20e41f5/docs), including [Codex configuration](https://github.com/diegosouzapw/OmniRoute/blob/0730eee9f2a2185395b2dbe652f33187d20e41f5/docs/guides/CODEX-CLI-CONFIGURATION.md), [Docker](https://github.com/diegosouzapw/OmniRoute/blob/0730eee9f2a2185395b2dbe652f33187d20e41f5/docs/guides/DOCKER_GUIDE.md), and [remote mode](https://github.com/diegosouzapw/OmniRoute/blob/0730eee9f2a2185395b2dbe652f33187d20e41f5/docs/guides/REMOTE-MODE.md); branch context `release/v3.8.49`, installed/released line `3.8.48` | `upstream-documented` plus `local-observation`: OpenAI-compatible model plane, documented Codex custom-provider path, supervised local deployment. No complete documented health/quota/price source is assumed; never treat `/v1/models` as readiness | OmniRoute/Codex upgrade, route failure, or monthly review |
